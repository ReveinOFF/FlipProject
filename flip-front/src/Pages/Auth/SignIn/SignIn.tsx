...
export const SignIn = () => {
    ...
    password: yup
        .string()
        .required("Пароль є обов'язкови полем")
    });
        ...
        <>
            ...
            <FormikProvider value={formik}>
                <Form className='form' onSubmit={handleSubmit}>
                    <input className={errors.name && touched.name ? "error-input" : "input-name"} value={values.name} onChange={handleChange} onBlur={handleBlur} name="name" type="text" placeholder='E-Mail або нікнейм'/>
                    {touched.name && errors.name && <div className='error'>{errors.name}</div>}

                    <div className='form-pass'>
                        <input className={errors.password && touched.password ? "input-pasw error-input" : "input-pasw"} type={visible ? "text" : "password"} value={values.password} onChange={handleChange} onBlur={handleBlur} name="password" placeholder='Пароль'/>
                    ...
                    <button className={!(dirty && isValid) ? "btn-log-error" : "btn-log"} type="submit" disabled={!(dirty && isValid)}>Увійти</button>
                </Form>
            </FormikProvider>
            <div className='other'>
                <div className='data'>

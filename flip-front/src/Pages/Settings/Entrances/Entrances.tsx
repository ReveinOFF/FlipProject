...
import { GetEntrances } from "../../../Interface/Entrances";
...
export const Entrances = () => {
  ...
  const [entrances, setEntrances] = useState<GetEntrances[]>([]);
  ...
  const { isLoaded } = useJsApiLoader({
    googleMapsApiKey: "AIzaSyCZNDyteKYZ1eaCfREBTUm_iLMfW_0WBqo",
  });
        ...
        {entrances?.map((item, index) => (
          <div className={styles.container} key={index}>
            <div
              ...
              onClick={() => {
                var enterans = [...entrances];
                enterans[index].show = !enterans[index].show;
                setEntrances(enterans);
              }}
            >
              <svg
                width="31"
            ...
            >
              ...
              <svg
                className={
                  item.show ? styles.rotate_arrow_active : styles.rotate_arrow
                }
                width="24"
                height="24"
                viewBox="0 0 24 24"
